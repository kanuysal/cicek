...
((function () {
  ...
  ((e = window.device),
    ...
    (i = function () {
      return device.landscape()
        ? (u("portrait"), t("landscape"))
        : (u("landscape"), t("portrait"));
    }),
    (a = "onorientationchange" in window),
    (o = a ? "orientationchange" : "resize"),
    window.addEventListener
      ? window.addEventListener(o, i, !1)
      : window.attachEvent
        ? window.attachEvent(o, i)
        : (window[o] = i),
    i());
}).call(this),
  define(
  ...
  define("config", ["modernizr", "libs/device"], function (e, t) {
    var n = {
      SITE_URL: "http://",
    ...
    return (
      (n.BASE_URL = window.location.pathname.substring(
        0,
  ...
  (function (e, t) {
    ...
    function q(e, n, r, i) {
      ...
      return (
        ...
        typeof n == "string"
          ? ((s = o[n]), s == null && (s = o[w.camelCase(n)]))
          : (s = o),
        s
      );
    }
      ...
      if (t) {
        ...
        if (r) {
          (w.isArray(t)
            ...
            : t in r
              ? (t = [t])
              : ((t = w.camelCase(t)), t in r ? (t = [t]) : (t = t.split(" "))),
            (i = t.length));
    ...
    function Mt(e, t) {
      return w.nodeName(e, "table") &&
        w.nodeName(t.nodeType === 1 ? t : t.firstChild, "tr")
    ...
    function un(e, t, n) {
      var r = !0,
        ...
        s = qt(e),
        o =
          w.support.boxSizing && w.css(e, "boxSizing", !1, s) === "border-box";
      if (i <= 0 || i == null) {
        i = Rt(e, t, s);
    ...
    function nr(e, t, n) {
      ...
      (n.queue ||
        ...
        e.nodeType === 1 &&
          ...
          w.css(e, "display") === "inline" &&
            w.css(e, "float") === "none" &&
            (!w.support.inlineBlockNeedsLayout || an(e.nodeName) === "inline"
    ...
    ((w.Callbacks = function (e) {
      ...
      (w.support = (function (t) {
        ...
        ((u = o.createElement("select")),
          ...
          (t.html5Clone =
            o.createElement("nav").cloneNode(!0).outerHTML !== "<:nav></:nav>"),
        ...
        return (
          ...
          w(function () {
            ...
            ((n = o.createElement("div")),
              ...
              w.swap(a, a.style.zoom != null ? { zoom: 1 } : {}, function () {
                t.boxSizing = p.offsetWidth === 4;
              }),
              e.getComputedStyle &&
                ((t.pixelPosition =
                  (e.getComputedStyle(p, null) || {}).top !== "1%"),
                (t.boxSizingReliable =
    ...
    (w.fn.extend({
      ...
      w.extend({
        ...
        attr: function (e, n, r) {
          ...
          if (r === t)
            return s && "get" in s && (o = s.get(e, n)) !== null
              ? o
              : ((o = w.find.attr(e, n)), o == null ? t : o);
          if (r !== null)
            return s && "set" in s && (o = s.set(e, r, n)) !== t
              ? o
    ...
    ((w.event = {
      ...
      handlers: function (e, n) {
        ...
        return (
          a < n.length && u.push({ elem: this, handlers: n.slice(a) }),
          u
        );
      },
      fix: function (e) {
    ...
    (w.fn.extend({
      ...
      is: function (e) {
        return !!ht(
          this,
          typeof e == "string" && ft.test(e) ? w(e) : e || [],
          !1,
        ).length;
      },
    ...
    (w.fn.extend({
      ...
      w.each(["height", "width"], function (e, t) {
        w.cssHooks[t] = {
          get: function (e, n, r) {
            if (n)
              return e.offsetWidth === 0 && Xt.test(w.css(e, "display"))
            ...
            return sn(
              ...
              r
                ? on(
                    ...
                    r,
                    w.support.boxSizing &&
                      w.css(e, "boxSizing", !1, i) === "border-box",
                    i,
                  )
                : 0,
            );
      ...
      w(function () {
        (w.support.reliableMarginRight ||
          (w.cssHooks.marginRight = {
            get: function (e, t) {
              if (t)
                return w.swap(e, { display: "inline-block" }, Rt, [
                  e,
                  "marginRight",
                ]);
            },
        ...
        ((w.expr.filters.hidden = function (e) {
          return (
            ...
            (!w.support.reliableHiddenOffsets &&
              ((e.style && e.style.display) || w.css(e, "display")) === "none")
          );
        }),
        ...
        _default: {
          get: function (e) {
            ...
            return e.elem[e.prop] == null ||
              ...
              ? ((t = w.css(e.elem, e.prop, "")), !t || t === "auto" ? 0 : t)
              : e.elem[e.prop];
          },
          set: function (e) {
            w.fx.step[e.prop]
    ...
    ((p.reduce =
      ...
      (p.shuffle = function (e) {
        var t = e && e.length === +e.length ? e : p.values(e),
          ...
          r = Array(n);
        for (var i = 0, s; i < n; i++)
          ((s = p.random(0, i)), s !== i && (r[i] = r[s]), (r[s] = t[i]));
        return r;
      }),
          ...
          if (this._wantsHashChange && this._wantsPushState) {
            ...
            this._hasPushState &&
              ...
              this.history.replaceState(
                {},
                document.title,
                this.root + this.fragment + o.search,
              ));
          }
...
((_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
        ...
        return (
          ...
          (v.staggerTo = function (e, t, i, s, u, a, f, l) {
            ...
            for (
              ...
              (i.startAt && (i.startAt = h(i.startAt)),
                p.to(e[c], t, h(i), c * s));
            return this.add(p, u);
          }),
          ...
          (v.add = function (i, s, o, a) {
            ...
            if (
              ...
              if (i instanceof Array || (i && i.push && u(i))) {
                for (
                  o = o || "normal", a = a || 0, f = s, l = i.length, c = 0;
                  l > c;
                  c++
                )
                  (u((h = i[c])) && (h = new r({ tweens: h })),
                    this.add(h, f),
                    "string" != typeof h &&
                      "function" != typeof h &&
                      ("sequence" === o
          ...
          (v._parseTimeOrLabel = function (t, n, r, i) {
            ...
            if ("string" == typeof n)
              return this._parseTimeOrLabel(
                n,
                r && "number" == typeof t && null == this._labels[n]
                  ? t - this.duration()
                  : 0,
                r,
              );
            if (
              ...
              ((n =
                ...
                (t =
                  s > 1
                    ? this._parseTimeOrLabel(t.substr(0, s - 1), 0, r)
                    : this.duration()));
            }
            return Number(t) + n;
          }),
                ...
                ? ((this._totalTime = this._time = h),
                  this._reversed ||
                    ...
                    0 === this._duration &&
                      ...
                      this._first &&
                      ((c = !0),
                      this._rawPrevTime > i && (u = "onReverseComplete"))),
                  (this._rawPrevTime =
          ...
          (v.getTweensOf = function (e, t) {
            var r,
              ...
              u = 0;
            for (
              s && this._enabled(!0, !0), r = n.getTweensOf(e), i = r.length;
              --i > -1;
            )
              (r[i].timeline === this || (t && this._contains(r[i]))) &&
                (o[u++] = r[i]);
            ...
            return (
              ...
              (u.onStart = function () {
                (o.target.paused(!0),
                  ...
                  n.onStart &&
                    n.onStart.apply(n.onStartScope || o, n.onStartParams || s));
              }),
              o
            );
          }),
    ...
    (function () {
      var e = 180 / Math.PI,
          ...
          if (o)
            for (e = [o].concat(e), a = e.length; --a > -1; )
              "string" == typeof (h = e[a][r]) &&
                "=" === h.charAt(1) &&
                (e[a][r] = o[r] + Number(h.charAt(0) + h.substr(2)));
          if (((u = e.length - 2), 0 > u))
        ...
        c = function (e, t, n) {
          ...
          for (f = y.length; --f > -1; ) {
            for (
              h = y[f], v[h] = a = [], p = 0, c = e.length, l = 0;
              c > l;
              l++
            )
              ((r =
        ...
        h = function (e, t, n) {
          for (
            var r, i, s, o, u, a, f, l, c, h, p, d = 1 / n, v = e.length;
            --v > -1;
          )
            for (
              h = e[v],
        ...
        v = d.prototype;
      ((d.bezierThrough = l),
        (d.cubicToQuadratic = u),
        (d._autoCSS = !0),
        (d.quadraticToCubic = function (e, t, n) {
    ...
    _gsScope._gsDefine(
      ...
      function (e, t) {
        ...
        var f,
              ...
              ? (!r && e.style[t]
                  ...
                  : (n = n || V(e))
                    ? (s =
                        ...
                        n.getPropertyValue(t.replace(T, "-$1").toLowerCase()))
          ...
          J = (F.convertToPixels = function (e, n, r, i, s) {
            ...
            if ((p && (r = -r), "%" === i && -1 !== n.indexOf("border")))
              ...
              (c.appendChild(B),
                (u = parseFloat(B[l ? "offsetWidth" : "offsetHeight"])),
                c.removeChild(B),
                l &&
                  "%" === i &&
                  o.cacheWidths !== !1 &&
                  ((a = c._gsCache = c._gsCache || {}),
                  (a.time = f),
                  (a.width = 100 * (u / r))),
                0 !== u || s || (u = J(e, n, r, i, !0)));
            }
          ...
          K = (F.calculateOffset = function (e, t, n) {
            ...
            var r = "left" === t ? "Left" : "Top",
              i = $(e, "margin" + r, n);
            return (
              e["offset" + r] - (J(e, t, parseFloat(i), i.replace(b, "")) || 0)
            );
          }),
          Q = function (e, t) {
            var n,
          ...
          et = function (e, t, n) {
            ...
            for (n = n || V(e, null); --s > -1; )
              ((r -= parseFloat($(e, "padding" + i[s], n, !0)) || 0),
          ...
          tt = function (e, t) {
            ...
            return (
              ...
              t &&
                ...
                (t.oxr = "=" === r.charAt(1)),
                (t.oyr = "=" === i.charAt(1)),
                (t.ox = parseFloat(r.replace(y, ""))),
                (t.oy = parseFloat(i.replace(y, "")))),
              r + " " + i + (n.length > 2 ? " " + n[2] : "")
            );
          },
          nt = function (e, t) {
        ...
        var ft = function (e, t, n, r) {
            ...
            ((F._setPluginRatio = function (e) {
              ...
              for (
                ...
                ((t = o[u.v]),
                  ...
                  (u = u._next));
              if (
                (s.autoRotate && (s.autoRotate.rotation = o.rotation), 1 === e)
              )
                for (u = s.firstMPT; u; ) {
                  if (((n = u.t), n.type)) {
                    if (1 === n.type) {
          ...
          ht =
            ((F._parseToProxy = function (e, t, n, r, i, s) {
              var o,
                u,
                a,
                f,
        ...
        var vt = function (e, t) {
            ((t = t || {}),
              ...
              (this.format =
                t.formatter ||
                ft(t.defaultValue, t.color, t.collapsible, t.multi)),
            ...
            if (!u[e]) {
              ...
              mt(e, {
                parser: function (e, n, r, i, s, o, a) {
                  var f = (_gsScope.GreenSockGlobals || _gsScope).com.greensock
                    .plugins[t];
                  return f
                    ? (f._cssRegister(), u[r].parse(e, n, r, i, s, o, a))
                    : (U("Error: " + t + " js file not loaded."), s);
                },
              });
            }
          };
        ((a = vt.prototype),
          (a.parseComplex = function (e, t, n, r, i, s) {
            ...
            if (
              ...
              for (
                f = a.length > u.length ? a.length : u.length, o = 0;
                f > o;
                o++
              )
                ((t = u[o] = u[o] || this.dflt),
          ...
          (a.parse = function (e, t, n, r, s, o) {
            return this.parseComplex(
              e.style,
              this.format($(e, this.p, i, !1, this.dflt)),
              this.format(t),
              s,
              o,
            );
        ...
        var yt =
          ...
          Tt = (F.getTransform = function (e, t, n, r) {
            ...
            var i,
              ...
              m,
              g,
              y = n ? e._gsTransform || new xt() : new xt(),
              b = 0 > y.scaleX,
              w = 2e-5,
              E = 1e5,
              S = 179.99,
              x = S * _,
              T = St
                ? parseFloat($(e, Et, t, !1, "0 0 0").split(" ")[2]) ||
                  y.zOrigin ||
                  0
                : 0;
            if (
              (bt
                ? (i = $(e, wt, t, !0))
                : e.currentStyle &&
                  ((i = e.currentStyle.filter.match(A)),
                  (i =
                    i && 4 === i.length
                      ? [
                          i[0].substr(4),
              ...
              for (
                s = (i || "").match(/(?:\-|\b)[\d\-\.e]+\b/gi) || [],
                  u = s.length;
                --u > -1;
              )
                ((a = Number(s[u])),
                  (s[u] = (f = a - (a |= 0))
                    ? (0 | (f * E + (0 > f ? -0.5 : 0.5))) / E + a
                    : a));
              if (16 === s.length) {
                var N = s[8],
                  C = s[9],
                ...
                if (
                  (y.zOrigin &&
                    ...
                    (L = N * M - s[12]),
                    (O = C * M - s[13]),
                    (M = k * M + y.zOrigin - s[14])),
                  !n || r || null == y.rotationX)
                ) {
                  var P,
                    H,
                    B,
                  ...
                  ((y.rotationX = G * D),
                    ...
                    q && Y
                      ...
                      : q && I
                        ...
                        : I && Y && (y.rotationY = y.rotationX = 0),
                    (y.scaleX = (0 | (Math.sqrt(R * R + U * U) * E + 0.5)) / E),
                    (y.scaleY = (0 | (Math.sqrt(V * V + C * C) * E + 0.5)) / E),
                    (y.scaleZ = (0 | (Math.sqrt(J * J + k * k) * E + 0.5)) / E),
                    (y.skewX = 0),
                ...
                for (
                  p = r.ieOffsetX || 0,
                    ...
                    r.ieOffsetX = Math.round(
                      (m - ((0 > u ? -u : u) * m + (0 > a ? -a : a) * g)) / 2 +
                        S,
                    ),
                    r.ieOffsetY = Math.round(
                      (g - ((0 > l ? -l : l) * g + (0 > f ? -f : f) * m)) / 2 +
                        x,
                    ),
                    dt = 0;
                  4 > dt;
                  ...
                  ((N = Z[dt]),
                    ...
                    (n =
                      -1 !== T.indexOf("px")
                        ? parseFloat(T)
                        : J(this.t, N, parseFloat(T), T.replace(b, "")) || 0),
                    (C =
                      n !== r[N]
                        ? 2 > dt
                          ? -r.ieOffsetX
          ...
          Ct = (F.set3DTransformRatio = function (e) {
            ...
            if (h) {
              ...
              (B > L && L > -B && (L = O = 2e-5),
                B > A && A > -B && (A = O = 2e-5),
                !H || N.z || N.rotationX || N.rotationY || (H = 0));
            }
            if (k || N.skewX)
              ((b = Math.cos(k)),
                (w = Math.sin(k)),
            ...
            ((c = 1),
              ...
              1 !== A && ((n *= A), (o *= A), (l *= A), (v *= A)),
              1 !== L && ((t *= L), (s *= L), (f *= L), (d *= L)),
              g && ((p -= g), (i = r * p), (a = u * p), (p = c * p + g)),
              (i = (E = (i += M) - (i |= 0))
                ? (0 | (E * y + (0 > E ? -0.5 : 0.5))) / y + i
                : i),
              (a = (E = (a += D) - (a |= 0))
                ? (0 | (E * y + (0 > E ? -0.5 : 0.5))) / y + a
                : a),
              (p = (E = (p += P) - (p |= 0))
                ? (0 | (E * y + (0 > E ? -0.5 : 0.5))) / y + p
                : p),
              (C[bt] =
                (N.xPercent || N.yPercent
                  ? "translate(" +
        ...
        (mt(
          "transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent",
          {
            parser: function (e, t, n, r, s, u, a) {
              ...
              var f,
                ...
                d,
                v,
                m = (r._transform = Tt(e, i, !0, a.parseTransform)),
                g = e.style,
                y = 1e-6,
                b = yt.length,
                w = a,
              ...
              if ("string" == typeof w.transform && bt)
                ...
                ("string" == typeof w.x &&
                  -1 !== w.x.indexOf("%") &&
                  ((f.x = 0), (f.xPercent = rt(w.x, m.xPercent))),
                  "string" == typeof w.y &&
                    -1 !== w.y.indexOf("%") &&
                    ((f.y = 0), (f.yPercent = rt(w.y, m.yPercent))),
                  (f.rotation = it(
                    "rotation" in w
                      ? w.rotation
                      : "shortRotation" in w
                  ...
                  (f.skewX = null == w.skewX ? m.skewX : it(w.skewX, m.skewX)),
                  (f.skewY = null == w.skewY ? m.skewY : it(w.skewY, m.skewY)),
                  (l = f.skewY - m.skewY) &&
                    ((f.skewX += l), (f.rotation += l)));
              }
              for (
                St && null != w.force3D && ((m.force3D = w.force3D), (d = !0)),
                ...
                (h || (St && p && m.zOrigin)) &&
                  (bt
                    ? ((d = !0),
                      (n = Et),
                      (h = (h || $(e, n, i, !1, "50% 50%")) + ""),
                      (s = new ht(g, n, 0, 0, s, -1, "transformOrigin")),
                      (s.b = g[n]),
                      (s.plugin = u),
                      St
                        ? ((c = m.zOrigin),
                          ...
                          (s = new ht(m, "zOrigin", 0, 0, s, -1, s.n)),
                          (s.b = c),
                          (s.xs0 = s.e = m.zOrigin))
                        : (s.xs0 = s.e = h))
                    : tt(h + "", m)),
                d &&
                  (r._transformType = p || 3 === this._transformType ? 3 : 2),
                s
              );
            },
            prefix: !0,
          ...
          mt("borderRadius", {
            ...
            parser: function (e, t, n, s, o) {
              ...
              for (
                ...
                (this.p.indexOf("border") && (x[a] = X(x[a])),
                  (c = l = $(e, x[a], i, !1, "0px")),
                  -1 !== c.indexOf(" ") &&
                    ((l = c.split(" ")), (c = l[0]), (l = l[1])),
                  (h = f = u[a]),
                  (p = parseFloat(c)),
                  (y = c.substr((p + "").length)),
                  (b = "=" === h.charAt(1)),
                  ...
                  "" === g && (g = r[n] || y),
                  g !== y &&
                    ((w = J(e, "borderLeft", p, y)),
                    (E = J(e, "borderTop", p, y)),
                    "%" === g
                      ? ((c = 100 * (w / v) + "%"), (l = 100 * (E / m) + "%"))
                      : "em" === g
                        ? ((S = J(e, "borderLeft", 1, "em")),
                          (c = w / S + "em"),
                          (l = E / S + "em"))
                        : ((c = w + "px"), (l = E + "px")),
                    b &&
            ...
            parser: function (e, t, n, r, s, o) {
              var u,
                ...
                m = this.format(
                  (v
                    ? d
                      ? v.getPropertyValue(p + "-x") +
                        " " +
                        v.getPropertyValue(p + "-y")
                      : v.getPropertyValue(p)
          ...
          mt("backgroundSize", { defaultValue: "0 0", formatter: tt }),
            ...
            parser: function (e, t, n, r, s, o) {
              ...
              return (
                9 > d
                  ...
                  : ((u = this.format($(e, this.p, i, !1, this.dflt))),
                    (t = this.format(t))),
          ...
          mt("border", {
            ...
            parser: function (e, t, n, r, s, o) {
              return this.parseComplex(
                e.style,
                this.format(
                  $(e, "borderTopWidth", i, !1, "0px") +
                    " " +
                    $(e, "borderTopStyle", i, !1, "solid") +
                    " " +
                    $(e, "borderTopColor", i, !1, "#000"),
                ),
                this.format(t),
                s,
                o,
        ...
        var Lt = function (e) {
          ...
          (100 === i &&
            ...
            -1 === r.indexOf("radient(") &&
            -1 === r.indexOf("oader(")
              ? (n.removeAttribute("filter"), (t = !$(this.data, "filter")))
              : ((n.filter = r.replace(S, "")), (t = !0))),
            t ||
          ...
          parser: function (e, t, n, r, s, o) {
            ...
            return (
              "string" == typeof t &&
                "=" === t.charAt(1) &&
                (t =
                  ("-" === t.charAt(0) ? -1 : 1) * parseFloat(t.substr(2)) + u),
              f &&
                1 === u &&
                "hidden" === $(e, "visibility", i) &&
                0 !== t &&
                (u = 0),
              q
                ? (s = new ht(a, "opacity", u, t - u, s))
                : ((s = new ht(a, "opacity", 100 * u, 100 * (t - u), s)),
                  (s.xn1 = f ? 1 : 0),
                  (a.zoom = 1),
                  (s.type = 2),
        ...
        mt("className", {
          parser: function (e, t, r, s, o, u, a) {
            var f,
              ...
              v = e.style.cssText;
            if (
              ((o = s._classNamePT = new ht(e, r, 0, 0, o, 2)),
              (o.setRatio = Ot),
              (o.pr = -11),
              (n = !0),
              (o.b = d),
        ...
        ((a = o.prototype),
          ...
          (a._onInitTween = function (e, t, u) {
            ...
            if (
              (l &&
                "" === S.zIndex &&
                ((a = $(e, "zIndex", i)),
                ("auto" === a || "" === a) && this._addLazySet(S, "zIndex", 0)),
              "string" == typeof t &&
                ((v = S.cssText),
                (a = Q(e, i)),
                (S.cssText = v + ";" + t),
                (a = G(e, a, Q(e)).difs),
                !q && E.test(t) && (a.opacity = parseFloat(RegExp.$1)),
                (t = a),
                (S.cssText = v)),
              ...
              ((b = new ht(e, "transform", 0, 0, null, 2)),
                ...
                (b.setRatio = w && St ? Ct : bt ? kt : Nt),
                (b.data = this._transform || Tt(e, i, !0)),
                s.pop());
            }
            if (n) {
              for (; h; ) {
                    ...
                    (m && x.test(p))
                      ? (m ||
                          ...
                          (p =
                            ...
                            p.join(",") +
                            ")")),
                        (n = pt(y, o, h, p, !0, "transparent", n, 0, s)))
                        ...
                        ? ((l = parseFloat(h)),
                          ...
                          g
                            ? ((c = parseInt(p.charAt(0) + "1", 10)),
                              ...
                              (v = p.replace(b, "")))
                            : ((c = parseFloat(p)),
                              (v = m ? p.substr((c + "").length) || "" : "")),
                          "" === v && (v = o in r ? r[o] : d),
                          (p = c || 0 === c ? (g ? c + l : c) + v : t[o]),
                          d !== v &&
                            "" !== v &&
                            (c || 0 === c) &&
                            l &&
          ...
          (a.setRatio = function (e) {
            ...
            if (
              ...
              for (; i; )
                (2 !== i.type ? (i.t[i.p] = i.e) : i.setRatio(e),
                  (i = i._next));
          }),
          (a._enableTransforms = function (e) {
            ((this._transformType = e || 3 === this._transformType ? 3 : 2),
              (this._transform = this._transform || Tt(this._target, i, !0)));
          }));
        var _t = function () {
        ...
        var Dt = function (e, t, n) {
          var r, i, s, o;
          if (e.slice) for (i = e.length; --i > -1; ) Dt(e[i], t, n);
          else
    ...
    if (!n.TweenLite) {
      ...
      var y = [0, 0, 1, 1],
        ...
        S = (w.register = function (e, t, n, r) {
          for (
            ...
            for (
              s = a[l],
                i = r ? g("easing." + s, null, !0) : f.easing[s] || {},
                o = c.length;
              --o > -1;
            )
              ((u = c[o]),
      ...
      ((s = x.prototype),
        (s.addEventListener = function (e, t, n, r, i) {
          ...
          var s,
            ...
            l = 0;
          for (
            null == f && (this._listeners[e] = f = []), a = f.length;
            --a > -1;
          )
            ((s = f[a]),
              s.c === t && s.s === n
                ? f.splice(a, 1)
                : 0 === l && i > s.pr && (l = a + 1));
          (f.splice(l, 0, { c: t, s: n, up: r, pr: i }),
            this !== o || u || o.wake());
        }),
      ...
      (A(),
        ...
        (s.timeScale = function (e) {
          ...
          if (
            ((e = e || l), this._timeline && this._timeline.smoothChildTiming)
          ) {
      ...
      var M = g(
          ...
          function (t, n, r) {
            ...
            if (
              ((this._overwrite = a =
                null == a
                  ? R[M.defaultOverwrite]
                  : "number" == typeof a
                    ? a >> 0
                    : R[a]),
              (u || t instanceof Array || (t.push && p(t))) &&
                "number" != typeof t[0])
            )
              for (
                this._targets = o = c(t),
                      ...
                      ? s.length &&
                        ...
                        : ((this._siblings[i] = X(s, this, !1)),
                          1 === a &&
                            ...
                            V(s, this, null, 1, this._siblings[i]))
                      : ((s = o[i--] = M.selector(s)),
                        "string" == typeof s && o.splice(i + 1, 1))
                    : o.splice(i--, 1));
            else
              ((this._propLookup = {}),
      ...
      var P = [],
        H = {},
        B = (M._internals = { isArray: p, isSelector: _, lazyTweens: P }),
        j = (M._plugins = {}),
        F = (B.tweenLookup = {}),
        I = 0,
        q = (B.reservedProps = {
        ...
        W = (B.lazyRender = function () {
          ...
          for (H = {}; --e > -1; )
            ((r = P[e]),
              r &&
                r._lazy !== !1 &&
                (r.render(r._lazy, !1, !0), (r._lazy = !1)));
          P.length = 0;
        });
      ((z._startTime = o.time),
      ...
      var X = function (e, t, n) {
          ...
          for (s = i.length; --s > -1; )
            (u = i[s]) === t ||
              ...
              (u._timeline !== t._timeline
                ? ((f = f || $(t, 0, d)), 0 === $(u, f, d) && (h[p++] = u))
                : c >= u._startTime &&
                  u._startTime + u.totalDuration() / u._timeScale > c &&
                  (((d || !u._initted) && 2e-10 >= c - u._startTime) ||
                    (h[p++] = u)));
          for (s = p; --s > -1; )
            ((u = h[s]),
              2 === r && u._kill(n, e) && (o = !0),
        ...
        $ = function (e, t, n) {
          for (
            var r = e._timeline, i = r._timeScale, s = e._startTime;
            r._timeline;
          ) {
        ...
        (s._initProps = function (t, n, r, i) {
          ...
          for (s in this.vars) {
            if (((l = this.vars[s]), q[s]))
              ...
              j[s] &&
              (a = new j[s]())._onInitTween(t, this.vars[s], this)
            ) {
              for (
                this._firstPT = f =
                  {
      ...
      if (
        ...
        (M._onPluginEvent = function (e, t) {
          ...
          for (; u; )
            (u.pg && "function" == typeof u.t[e] && u.t[e]() && (n = !0),
              (u = u._next));
          return n;
        }),
  ...
  define(
    "view/preloader",
    ["jquery", "underscore", "view/common/base_view", "data/drop", "TweenMax"],
    function (e, t, n, r, i) {
      return n.extend({
        instance: null,
        ctx0: null,
        ...
        initialize: function () {
          (t.bindAll(
            ...
            (this.$loader_canvas = e(".loader-canvas-js")));
        },
        show: function () {
          (i.to(this.$loader_canvas, 0, { opacity: 0 }),
        ...
        colorAnimate: function () {
          if (!this.$can0) return;
          (i.to(this.$can0, 0.75, { opacity: 0.4, ease: Power0.easeInOut }),
            i.to(this.$can1, 0.75, { opacity: 0.4, ease: Power0.easeInOut }),
            i.to(this.$can2, 0.75, {
              opacity: 0.4,
        ...
        colorAnimateBack: function () {
          if (!this.$can0) return;
          (i.to(this.$can0, 0.75, { opacity: 0.1, ease: Power0.easeInOut }),
            i.to(this.$can1, 0.75, { opacity: 0.1, ease: Power0.easeInOut }),
            i.to(this.$can2, 0.75, {
              opacity: 0.1,
        ...
        update: function () {
          ((this.index = parseInt((r.length - 1) * this.progress, 10)),
            this.loop());
        },
        ...
        kill: function () {
          (i.killTweensOf(this),
            e("#preloader-container").remove(),
            this.onHideComplete());
        },
        createCanvas: function () {
          var t = e("#logo-canvas-0")[0];
          if (!t) return;
          ((this.$can0 = e("#logo-canvas-0")),
            (this.ctx0 = t.getContext("2d")),
            (t.width = 100 * this.ratio),
            (t.height = 150 * this.ratio),
            this.$can0.css({ width: 100, height: 150 }));
          var n = e("#logo-canvas-1")[0];
          ((this.$can1 = e("#logo-canvas-1")),
            (this.ctx1 = n.getContext("2d")),
            (n.width = 100 * this.ratio),
            (n.height = 150 * this.ratio),
            this.$can1.css({ width: 100, height: 150 }));
          var r = e("#logo-canvas-2")[0];
          ((this.$can2 = e("#logo-canvas-2")),
            (this.ctx2 = r.getContext("2d")),
            (r.width = 100 * this.ratio),
            (r.height = 150 * this.ratio),
            this.$can2.css({ width: 100, height: 150 }));
          var i = e("#logo-canvas-3")[0];
          ((this.$can3 = e("#logo-canvas-3")),
            (this.ctx3 = i.getContext("2d")),
            (i.width = 100 * this.ratio),
            (i.height = 150 * this.ratio),
            this.$can3.css({ width: 100, height: 150 }));
        },
        drawLinePart: function (e, t, n, r, i) {
          (r.beginPath(),
            (r.lineWidth = i),
            r.moveTo(e.x * this.ratio, e.y * this.ratio),
            (r.strokeStyle = "rgba(0, 0, 0," + n + ")"),
            r.lineTo(t.x * this.ratio, t.y * this.ratio),
            r.stroke(),
            r.closePath());
        },
        loop: function () {
          if (!this.ctx0) return;
          var e = { x: r[this.index].x, y: r[this.index].y },
            t = 1,
            n = 1 / this.step,
            i = r.length;
          (this.ctx0.clearRect(0, 0, 100 * this.ratio, 150 * this.ratio),
            this.ctx1.clearRect(0, 0, 100 * this.ratio, 150 * this.ratio),
            this.ctx2.clearRect(0, 0, 100 * this.ratio, 150 * this.ratio),
            this.ctx3.clearRect(0, 0, 100 * this.ratio, 150 * this.ratio));
          for (var s = 1; s < this.drawLenght; s++) {
            ...
            this.index + s >= i
              ...
              : (o = this.index + s);
            var u = r[o];
            (this.drawLinePart(e, u, t, this.ctx0, 6 * this.ratio),
              this.drawLinePart(
                e,
                u,
                1,
                this.ctx1,
                this.lineThickness * this.ratio,
              ),
              this.drawLinePart(
                e,
                u,
  ...
  require(["config", "view/preloader"], function (e, t) {
    ...
    ((t.instance = n),
      n.show(),
      (document.getElementsByClassName("js-loader")[0].style.display = ""));
    var i = [],
      s = [],
      o = null;
    (e.MOBILE
      ? ((e.FLOW = e.FLOWS.MOBILE),
        s.push(e.CDN + "/css/main.css"),
        i.push("main_desktop_extended"))
      : e.OLD_DESKTOP
        ? ((e.FLOW = e.FLOWS.BASIC),
          s.push(e.CDN + "/css/main.css"),
          i.push("main_desktop_extended"))
        : e.TABLET
          ? ((e.FLOW = e.FLOWS.TABLET),
            s.push(e.CDN + "/css/main.css"),
            i.push("main_desktop_extended"))
          : ((e.FLOW = e.FLOWS.EXTENDED),
            s.push(e.CDN + "/css/main.css"),
            i.push("main_desktop_extended")),
      window.location.toString().indexOf("?testing") > -1 &&
        (o = "tests/mocha"),
      r(s),
      require(i, function (e) {
        o
